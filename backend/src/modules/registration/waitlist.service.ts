...
export class WaitlistService {
     ...
     */
    async joinWaitlist(userId: string, cohortId: string): Promise<WaitlistEntryResponse> {
     ...
     */
    async getWaitlistPosition(userId: string, cohortId: string): Promise<WaitlistEntryResponse | null> {
     ...
     */
    async getUserWaitlistEntries(userId: string): Promise<WaitlistEntryResponse[]> {
     ...
     * Leave waitlist
     */
    async leaveWaitlist(userId: string, cohortId: string): Promise<{ success: boolean }> {
        const entry = await this.prisma.waitlistEntry.findUnique({
            where: {
                userId_cohortId: { userId, cohortId },
            },
