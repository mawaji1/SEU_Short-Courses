...
- [ ] Sample programs (10-15)
- [ ] Sample categories (5-7)
- [ ] Sample instructors (5-10)
- [ ] Sample cohorts with dates
...
**Status:** Backend complete, frontend scaffolded but needs implementation
