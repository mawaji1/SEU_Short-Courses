        ...
        if (paymentId) {
            ...
            setTimeout(() => {
                setPaymentData({
                    id: paymentId,
                    amount: 1500,
                    program: 'أساسيات الذكاء الاصطناعي',
                    cohort: 'الموعد الأول - يناير 2026',
                });
                setIsLoading(false);
            }, 1500);
        } else {
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 mb-8 text-right">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium text-gray-900">{paymentData.program}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-gray-600">الموعد</span>
                                        <span className="font-medium text-gray-900">{paymentData.cohort}</span>
                                    </div>
