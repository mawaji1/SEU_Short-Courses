...
export class RegistrationController {
    ...
    async initiateRegistration(
        ...
        return this.registrationService.initiateRegistration(req.user.sub, dto);
    }
    ...
    async getRegistrationById(
        ...
        return this.registrationService.getRegistrationById(req.user.sub, id);
    }
    ...
    async confirmRegistration(
        ...
        return this.registrationService.confirmRegistration(req.user.sub, {
            registrationId: id,
    ...
    async cancelRegistration(
        ...
        return this.registrationService.cancelRegistration(req.user.sub, {
            registrationId: id,
            reason: dto.reason,
        });
    }
    ...
    async joinWaitlist(
        ...
        return this.waitlistService.joinWaitlist(req.user.sub, body.cohortId);
    }
