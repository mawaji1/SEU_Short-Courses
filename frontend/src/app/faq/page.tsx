...
const faqs = [
    ...
    },
    {
        ...
        answer: "نعم، جميع شهاداتنا معتمدة من الجامعة السعودية الإلكترونية، وهي مؤسسة حكومية للتعليم العالي. الشهادة تحمل رقم تحقق فريد يمكن التحقق منه إلكترونياً عبر المنصة.",
    },
    {
        category: "certificates",
    ...
    },
    {
        ...
        answer: "يمكنك التواصل مع الدعم الفني عبر: 1) صفحة الدعم على المنصة، 2) البريد الإلكتروني: support@seu.edu.sa، 3) الهاتف: 920015555. ساعات العمل: الأحد - الخميس، 8 صباحاً - 4 مساءً.",
    },
];
