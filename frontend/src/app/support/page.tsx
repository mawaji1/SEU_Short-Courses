...
export const metadata: Metadata = {
    title: "الدعم الفني | التعليم التنفيذي - الجامعة السعودية الإلكترونية",
    description: "احصل على الدعم الفني لمنصة التعليم التنفيذي. نحن هنا لمساعدتك في أي استفسارات تتعلق بالتسجيل، الدفع، البرامج التدريبية، أو الشهادات.",
    openGraph: {
        title: "الدعم الفني | التعليم التنفيذي - SEU",
...
const supportOptions = [
    ...
    },
    {
        ...
        description: "راسلنا على support@seu.edu.sa",
        href: "mailto:support@seu.edu.sa",
        color: "bg-purple-500",
    },
    {
        icon: Phone,
        title: "اتصل بنا",
        description: "920015555 (الأحد - الخميس، 8ص - 4م)",
        href: "tel:920015555",
        color: "bg-orange-500",
    },
];
